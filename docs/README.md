...
| Document | Purpose |
|---|---|
| [Architecture](architecture.md) | Canonical system design, data contracts, delivery guarantees, crawler safety, and known boundaries. |
...
The component-specific notes under `frontier/`, `fetcher/`, `renderer/`,
`extractor/`, and `embedder/` are supplementary implementation references.

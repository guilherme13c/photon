...
pub const _KafkaProducer = struct {
    ...
    pub const VTable = struct {
        publish_discovered_url: *const fn (ctx: *anyopaque, url: []const u8) anyerror!void,
    ...
    pub inline fn publishDiscoveredUrl(self: _KafkaProducer, url: []const u8) !void {
        return self.vtable.publish_discovered_url(self.ptr, url);
    }

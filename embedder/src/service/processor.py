...
embeddings_processed_total = Counter('embedder_messages_processed_total', 'Total messages processed', ['status'])

class EmbeddingProcessorService:
    def __init__(self, model_name: str, vector_store: VectorStoreRepository, object_store: ObjectStoreRepository = None, producer = None):

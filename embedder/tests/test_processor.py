...
def test_process_message_valid_json(mocker, mock_vector_store, mock_object_store, mock_producer):
    ...
    processor = EmbeddingProcessorService("dummy-model", mock_vector_store, mock_object_store, mock_producer)
    ...
    mock_object_store.delete.assert_called_once_with("dummy.html")
